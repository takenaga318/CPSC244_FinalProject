...
**notes to be removed upon submission**
what gets turned in & where:
-single page (?) game design doc as a PDF on Canvas (to final project module??)
-project folder in google folder
-project build in google folder (might be the same one, idk for sure)
**PLS REMOVE THESE BEFORE OFFICAL SUBMISSION**